# HITSZ 助手 — 智能校园信息平台 HITA

[信息平台智能化架构和实现 ppt](file/HITA.pptx)

[demo 演示](file/hita.mp4)

![HITSZ 助手一览](images/hita_glance.png)
...
![HITA 项目目标概览](images/hita_overview.png)

-   用户体验：突破传统的UI，改用简洁的Material Design模式
...
θ社区则引入了智能敏感屏蔽手段。利用端侧算力完成文字的敏感词检测和图片的初步敏感标注任务，利用云端能力完成文字情感分析和图片的敏感判定任务。通过端云结合的敏感检测，θ社区能够有效地消除校园论坛的敏感信息风险。具体的功能和实现：
...
为了能够让大家更便利地享受服务，HITSZ助手从刚需出发，完全抛弃主流掌上校园信息平台臃肿的交互方式，构建层次感、主次感的交互逻辑，以简洁美观的UI和最清晰的交互，拒绝臃肿，为学生提供更便捷的服务。

![HITSZ 助手 UI](images/hita_ui.png)

## 项目前景

![HITSZ 助手用户数据](images/hita_user.png)

当前，该项目已经成功获得了哈尔滨工业大学（深圳）的相当大的用户份额，这表明从实践上来看，该项目已经取得了基本的成功。而HITA接下来的方向总结如下：
