...
const DICT = {
  ...
  'about.exp.7':  { zh: '<b>n-gram 商品评价模型</b>（队长）— 文本挖掘与相关性分析，美赛 Meritorious 奖', en: '<b>n-gram product review model</b> (Team Lead) — text mining & correlation analysis, MCM Meritorious' },
  'about.exp.8':  { zh: '<b>「沙漠掘金」决策模型</b>（队长）— 动态规划与混合 Nash 博弈，数模国赛二等奖', en: '<b>Gold-of-the-Desert decision model</b> (Team Lead) — dynamic programming & mixed-Nash game theory, CUMCM National 2nd Prize' },
  'about.exp.9':  { zh: '<b>All-in-Cloud 云计算综述</b>（组长）— 约 8k 字学术英语论文，含 Oral 与 Poster', en: '<b>All-in-Cloud survey</b> (Team Lead) — ~8k-word academic English paper with oral presentation & poster' },
  'about.exp.10': { zh: '<b>Naive SE 校园搜索引擎</b>— 基于 Lucene / IKAnalyzer / Tomcat 的中文检索系统', en: '<b>Naive SE campus search engine</b> — Chinese retrieval system on Lucene / IKAnalyzer / Tomcat' },
  'about.exp.11': { zh: '<b>MIT xv6 6.S081 实验</b> — 独立完成 1-9（Shell / Lazy / CoW / Lock / Mmap 等）', en: '<b>MIT xv6 6.S081 labs</b> — completed labs 1–9 independently (Shell, Lazy, CoW, Lock, Mmap, …)' },
  'about.exp.12': { zh: '<b>计算机网络全协议栈实验</b> — VLAN / RIP / NAT 配置、抓包解析与 Socket 编程', en: '<b>Full network protocol-stack labs</b> — VLAN/RIP/NAT, packet analysis and socket programming' },
