...
const DICT = {
  ...
  /* ---------- 通用返回链接（内页） ---------- */
  'common.back.home':  { zh: '← 返回主页', en: '← Back to Home' },
  'common.back.about': { zh: '← 返回关于', en: '← Back to About' },
  'common.back.works': { zh: '← 返回作品', en: '← Back to Works' },
  'common.back.blog':  { zh: '← 返回博客', en: '← Back to Blog' },

  /* ---------- 项目详情页标题 ---------- */
  'page.cscc':        { zh: '基于 RISC-V64 的多核操作系统 UltraOS', en: 'UltraOS — RISC-V64 Multiprocessor Operating System' },
  'page.nscscc':      { zh: 'FPGA 上基于双发射处理器的 UltraMIPS 系统', en: 'UltraMIPS — Dual-Issue Processor System on FPGA' },
  'page.cumcm':       { zh: '以最大收益为目标的出租车机场载客线性决策模型', en: 'Linear Decision Model for Taxi Airport Pickup' },
  'page.cumcm2020':   { zh: '「沙漠掘金」不同情景下的最优决策模型', en: 'Gold-of-the-Desert Optimal Decision Models' },
  'page.mcm':         { zh: '基于 n-gram 的亚马逊商品评价模型', en: 'n-gram Based Amazon Product Review Model' },
  'page.hita':        { zh: 'HITSZ 助手 — 智能校园信息平台', en: 'HITSZ Assistant — Smart Campus Information Platform' },
  'page.ruf':         { zh: 'Rust 编译器不稳定特性的发展、生态影响与缓解措施研究', en: 'Demystifying Compiler Unstable Feature Usage and Impacts in the Rust Ecosystem' },
  'page.rust4system': { zh: '基于 Rust 语言的系统搭建、防护与攻击', en: 'Building, Defending and Attacking Systems with Rust' },
  'page.aic':         { zh: 'All-in-Cloud：云计算挑战与未来展望', en: 'All-in-Cloud: Challenges and Future Expectations of AiC' },
  'page.naivese':     { zh: 'HITSZ 通知新闻搜索引擎：Naive SE', en: 'Naive SE — HITSZ News Search Engine' },
  'page.xv62019':     { zh: 'MIT xv6 6.S081 实验（2019）', en: 'MIT xv6 6.S081 Labs (2019)' },
  'page.award':       { zh: '所获荣誉', en: 'Honors & Awards' },
  'page.life':        { zh: '诗、想法、人生', en: 'Literature, Thoughts and Life' },

  /* ---------- 博客文章页标题 ---------- */
  'post.chuanxi-roadbook':    { zh: '川西小环线 5 日自驾路书', en: 'Western Sichuan Loop · 5-Day Road Book' },
  'post.wuxing-jiubian':      { zh: '五一感想', en: 'Reflections on May Day' },
  'post.lieblian':            { zh: '裂变', en: 'Fission' },
  'post.bukchixu':            { zh: '不可持续的李程浩', en: 'The Unsustainable Li Chenghao' },
  'post.keep-open':           { zh: 'Keep open to the world', en: 'Keep open to the world' },
  'post.xinzaizhenbian':      { zh: '心在枕边', en: 'Heart at the Pillowside' },
  'post.huiyi-gaozhong':      { zh: '回忆高中', en: 'Remembering High School' },
  'post.waimai-jinghun':      { zh: '外卖惊魂录', en: 'A Takeout Thriller' },
  'post.uncovered-2020':      { zh: '2020 Uncovered thought from LoanCold', en: '2020 Uncovered thought from LoanCold' },
  'post.zuijin-yixie-chenmi': { zh: '最近的一些沉迷和想要诉说的无理取闹', en: 'Recent Obsessions and Unreasonable Urges' },
  'post.baise-wujian':        { zh: '白色物件与灰色生活', en: 'White Objects and a Grey Life' },
  'post.shizai-lushang':      { zh: '今天在路上应该是踩中了一坨屎', en: 'Today I Must Have Stepped in It' },
  'post.live-in-house':       { zh: 'Live in the house of past memory', en: 'Live in the house of past memory' },
  ...
  'about.exp0.t': { zh: '腾讯 · 微信小游戏全栈性能优化工程师', en: 'Tencent · Full-Stack Performance Engineer, WeChat Mini Games' },
  'about.exp0.n': { zh: '2025 — 至今', en: '2025 — Present' },
  'about.edu1.t': { zh: '浙江大学 · 网络空间安全 · 硕士', en: 'Zhejiang University · Cyberspace Security · M.S.' },
  'about.edu1.n': { zh: '2022.09 — 2025.03 · 导师 申文博', en: '2022.09 — 2025.03 · Advisor: Shen Wenbo' },
  'about.edu2.t': { zh: '哈尔滨工业大学（深圳）· 计算机 · 本科', en: 'HIT (Shenzhen) · Computer Science · B.Eng.' },
  'about.edu2.n': { zh: '2018 — 2022 · 学分绩 94.07 (TOP 2%) · 导师 夏文', en: '2018 — 2022 · GPA 94.07 (Top 2%) · Advisor: Xia Wen' },
  'about.s3':     { zh: 'III. 主要作品', en: 'III. Works' },
  'about.link.icse':  { zh: "ICSE'24 ↗", en: "ICSE'24 ↗" },
  'about.link.tse':   { zh: "TSE'25 ↗", en: "TSE'25 ↗" },
  'about.exp.1.t': { zh: 'UltraMIPS · FPGA 双发射计算机系统（队长）', en: 'UltraMIPS · FPGA dual-issue computer system (Team Lead)' },
  'about.exp.1.d': { zh: '主频 91MHz、性能 63 倍 / IPC 34.6 倍，「龙芯杯」CPU 团队赛一等奖（总排名 2）', en: '91MHz, 63× performance / 34.6× IPC; Loongson Cup CPU Team First Prize (rank 2)' },
  'about.exp.2.t': { zh: 'UltraOS · RISC-V64 多核操作系统（队长）', en: 'UltraOS · RISC-V64 multiprocessor OS (Team Lead)' },
  'about.exp.2.d': { zh: 'Rust 编写、K210 双核、59 条系统调用；系统能力大赛 OS 内核赛道一等奖第一名', en: 'Written in Rust on dual-core K210 with 59 syscalls; OS Kernel Track First Prize (rank 1)' },
  'about.exp.3.t': { zh: 'Rust 编译器不稳定特性研究', en: 'Demystifying Rust Unstable Feature Usage' },
  'about.exp.3.d': { zh: 'ICSE\'24 (CCF-A) 与 TSE\'25 一作；解析 248M 依赖，99% 正确率', en: 'First author, ICSE\'24 (CCF-A) & TSE\'25; 248M deps at 99% precision' },
